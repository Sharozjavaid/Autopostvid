...
class GPTImageGenerator:
    ...
    # IMPORTANT: Visual description comes FIRST so the AI prioritizes it
    BACKGROUND_STYLE_TEMPLATE = """MAIN SUBJECT (MOST IMPORTANT - Generate exactly this):
{visual_description}

ARTISTIC STYLE (apply to the subject above):
- Dark moody atmosphere with dramatic Caravaggio chiaroscuro lighting
- Rich deep colors (burgundy, gold, deep blue)
- Mysterious shadows with golden highlights
